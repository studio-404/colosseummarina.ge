...
function _build_lists($parent, $order_by, $start = -1,$per_page)
{
    ...
    foreach ($results AS $result):
        $is_first = ($count == 1);
        $is_last = ($count >= $total);
        $arrow_up = $is_first ? '<img src="_cadmin/img/none.png" width="10" height="7" style="float:left;" />' : '<a href="' . ahref($action, 'move', array('where' => 'up', 'idx' => $result['idx'], 'menu' => $result['menuid'])) . '"><img src="_cadmin/img/buttons/icon_arrow_up_' . ($result['level'] == 1 ? 1 : 2) . '.png" class="star" title="' .  a('tt.moveup') . '" width="10" height="7" /></a>';
        $arrow_down = $is_last ? '<img src="_cadmin/img/none.png" width="10" height="7" style="float:left;" />' : '<a href="' . ahref($action, 'move', array('where' => 'down', 'idx' => $result['idx'], 'menu' => $result['menuid'])) . '"><img src="_cadmin/img/buttons/icon_arrow_down_' . ($result['level'] == 1 ? 1 : 2) . '.png" class="star" title="' .  a('tt.movedn') . '" width="10" height="7" /></a>';
		$arrows = ($order_by == 'position') ? $arrow_up . $arrow_down : '<img src="_cadmin/img/table.png" width="16" height="16" alt="" />';
...
?>
		<div id="title" class="fix">
			<div class="icon"><img src="_cadmin/img/buttons/_question.png" width="16" height="16" alt="" /></div>			
