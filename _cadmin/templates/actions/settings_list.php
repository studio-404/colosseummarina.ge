...
?>
					<div class="<?php echo $class;?> fix">
						...
						<div class="action2 fix">
							<a href="<?php echo ahref($section, 'edit', array('key'=>$setting['key']));?>" title="<?php echo a('ql.edit');?>"><img src="_cadmin/img/buttons/icon_edit.png" /></a>
<?php if($_SESSION['auth']["class"] == '0') { ?>
							<a href="javascript:del('<?php echo $setting['key'];?>', '<?php echo $setting['key'];?>');" title="<?php echo a('ql.delete');?>"><img src="_cadmin/img/buttons/icon_delete.png" /></a>
<?php } ?>
						</div>									
