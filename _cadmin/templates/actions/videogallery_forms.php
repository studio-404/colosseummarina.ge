    <div id="title" class="fix">
        ...
        <div class="name"><?php echo ($subaction=='add') ? a('addvideo') : a('editvideo');?></div>
    </div>	
    ...
    <div id="box">
        <div id="part">
            ...
            <div id="t1" style="display:inline; visibility:visible;">
                <div id="news">
<?php $ulink = ($subaction=="add") ? ahref('videogallery', 'add', array('menu' => $menu)) : ahref('videogallery', 'edit', array('menu' => $menu, 'idx' => $idx)); ?>
                <form id="catform" name="catform" method="post" action="<?php echo $ulink;?>">
                   	<input type="hidden" name="videogallery_form_perform" value="1" />
                        <div class="list2 fix">
