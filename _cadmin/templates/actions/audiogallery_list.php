...
?>
		<div id="title" class="fix">
			<div class="icon"><img src="_cadmin/img/buttons/_sound.png" width="16" height="16" alt="" /></div>			
...
<?php
	...
	if(count($images) > 0) :
		foreach($images as $audio) :
			$is_first = ($count == 1);
			$is_last = ($count >= $total);
			$arrow_up = $is_first ? '<img src="_cadmin/img/none.png" width="9" height="9" style="float:left;" />' : '<a href="' . ahref('audiogallery', 'move', array('where' => 'up', 'menu'=>$audio['galleryid'], 'idx'=> $audio['idx'])) . '"><img src="_cadmin/img/buttons/icon_arrow_up.png" alt="Move Up" title="Move Up" width="9" height="9" /></a>';
			$arrow_down = $is_last ? '<img src="_cadmin/img/none.png" width="9" height="9" style="float:left;" />' : '<a href="' . ahref('audiogallery', 'move', array('where' => 'down', 'menu'=>$audio['galleryid'], 'idx'=> $audio['idx'])) . '"><img src="_cadmin/img/buttons/icon_arrow_down.png" alt="Move Down" title="Move Down" width="9" height="9" /></a>';
...
?>
					<div id="list" class="<?php echo $class;?> fix">
						<div class="check">
							<a href="javascript:chclick(<?php echo $audio['idx'];?>);"><img src="_cadmin/img/buttons/icon_<?php echo $ch;?>visible.png" class="star" title="<?php echo a('tt.visibility');?>" id="img_<?php echo $audio['idx'];?>" style="width:9px;height:9px;" /></a>
						...
						<div class="action fix" style="padding-top:6px; width:120px;">
							<a href="<?php echo $audio['file'];?>" target="_blank" title="<?php echo a('ql.preview');?>"><img src="_cadmin/img/buttons/icon_preview.png" /></a>
							<a href="<?php echo ahref('audiogallery', 'edit', array('idx' => $audio['idx'], 'menu'=>$audio['galleryid']));?>" title="<?php echo a('ql.edit');?>"><img src="_cadmin/img/buttons/icon_edit.png" /></a>
							<a href="javascript:del(<?php echo $audio['id'];?>, '<?php echo $audio['title'];?>');" title="<?php echo a('ql.delete');?>"><img src="_cadmin/img/buttons/icon_delete.png" /></a>
						</div>									
					</div>		
<?php
		endforeach;
