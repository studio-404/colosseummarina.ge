...
?>
					<div id="user" class="<?php echo $class;?> fix">
						...
						<div class="check">
							<a href="javascript:banclick(<?php echo $user['id'];?>);"><img src="_cadmin/img/buttons/icon_<?php echo $bn;?>visible.png" class="star" title="<?php echo a('tt.visibility');?>" id="bimg_<?php echo $user['id'];?>" style="width:9px;height:9px;" /></a>
						...
						<div class="action fix" style="padding-top:6px; width:60px;">
							<a href="<?php echo ahref('siteusers', 'edit', array('id' => $user['id']));?>"><img src="_cadmin/img/buttons/icon_edit.png" class="star" title="<?php echo a('ql.editcontent');?>" /></a>
...
?>
				<div id="bottom" class="fix">
					<ul id="page" class="fix left">
						<li><a href="<?php echo ahref('siteusers', 'show', array('start' => 0));?>"><img src="_cadmin/img/prev2.png" width="5" height="5" alt=""  class="arrow" /></a></li>
						<li><a href="<?php echo ahref('siteusers', 'show', array('start' => $uc * ($j - 1)));?>"><img src="_cadmin/img/prev.png" width="5" height="5" alt=""  class="arrow" /></a></li>
<?php
...
?>
						<li><a href="<?php echo ahref('siteusers', 'show', array('start' => $uc * ($k - 1)));?>"><img src="_cadmin/img/next.png" width="5" height="5" alt="" class="arrow" /></a></li>
						<li><a href="<?php echo ahref('siteusers', 'show', array('start' => $uc * ($lastpage - 1)));?>"><img src="_cadmin/img/next2.png" width="5" height="5" alt="" class="arrow" /></a></li>
					</ul>
...
function banclick(id) {
	...
	$.post("<?php echo ahref('siteusers', 'ban');?>&id=" + id + "&banned=" + ban, function() {
		if(ban=='1') 
	        $('#bimg_'+id).attr("src","_cadmin/img/buttons/icon_visible.png"); 
		else
	        $('#bimg_'+id).attr("src","_cadmin/img/buttons/icon_unvisible.png"); 
		$('#ban_'+id).val(ban);
	});
};	
