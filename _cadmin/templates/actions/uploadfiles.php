...
<?php } ?>								
						...
						<div class="date">&nbsp;</div>	
						<ul class="action fix">
                        	<a href="<?php echo $folder . '/' . $file; ?>" target="_blank"><img src="_cadmin/img/buttons/icon_preview.png" class="star" title="<?php echo a('ql.preview');?>" /></a>
                            <a href="javascript:del('<?php echo $curnews["id"];?>', '<?php echo $file;?>', '<?php echo $file;?>');"><img src="_cadmin/img/buttons/icon_delete.png" class="star" title="<?php echo a('ql.delete');?>" /></a>
						</ul>		
