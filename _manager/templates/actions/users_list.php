...
?>
					<div id="user" class="<?php echo $class;?> fix">
						...
						<div class="action fix">
							<a href="<?php echo ahref('users', 'edit', array('id' => $user['id']));?>"><img src="_manager/img/buttons/icon_edit.png" class="star" title="<?php echo a('ql.editcontent');?>" /></a>
...
?>
				<div id="bottom" class="fix">
					<ul id="page" class="fix left">
						<li><a href="<?php echo ahref('users', 'show', array('start' => 0));?>"><img src="_manager/img/prev2.png" width="5" height="5" alt=""  class="arrow" /></a></li>
						<li><a href="<?php echo ahref('users', 'show', array('start' => $uc * ($j - 1)));?>"><img src="_manager/img/prev.png" width="5" height="5" alt=""  class="arrow" /></a></li>
<?php
...
?>
						<li><a href="<?php echo ahref('users', 'show', array('start' => $uc * ($k - 1)));?>"><img src="_manager/img/next.png" width="5" height="5" alt="" class="arrow" /></a></li>
						<li><a href="<?php echo ahref('users', 'show', array('start' => $uc * ($lastpage - 1)));?>"><img src="_manager/img/next2.png" width="5" height="5" alt="" class="arrow" /></a></li>
					</ul>
					<a href="<?php echo ahref('users', 'add');?>" class="button br" style="float: right"><?php echo a("newuser");?></a>
				</div>					
			</div>		
