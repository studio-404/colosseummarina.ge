...
<?php
	...
	if(count($catalogs) > 0) :
		foreach($catalogs as $catalog) :
			$is_first = ($count == 1);
			$is_last = ($count >= $total);
			$arrow_up = $is_first ? '<img src="_manager/img/none.png" width="9" height="9" style="float:left;" />' : '<a href="' . ahref('catalog', 'move', array('where' => 'up', 'menu'=>$catalog['catalogid'], 'idx'=> $catalog['idx'])) . '"><img src="_manager/img/buttons/icon_arrow_up.png" alt="Move Up" title="Move Up" width="9" height="9" /></a>';
			$arrow_down = $is_last ? '<img src="_manager/img/none.png" width="9" height="9" style="float:left;" />' : '<a href="' . ahref('catalog', 'move', array('where' => 'down', 'menu'=>$catalog['catalogid'], 'idx'=> $catalog['idx'])) . '"><img src="_manager/img/buttons/icon_arrow_down.png" alt="Move Down" title="Move Down" width="9" height="9" /></a>';
...
?>
					<div id="list" class="<?php echo $class;?> fix">
						<div class="check">
							<a href="javascript:chclick(<?php echo $catalog['idx'];?>);"><img src="_manager/img/buttons/icon_<?php echo $ch;?>visible.png" class="star" title="<?php echo a('tt.visibility');?>" id="img_<?php echo $catalog['idx'];?>" style="width:9px;height:9px;" /></a>
						...
						<div class="action fix">
							<a href="<?php echo ahref('catalog', 'edit', array('idx' => $catalog['idx'], 'menu'=>$catalog['catalogid']));?>" title="<?php echo a('ql.edit');?>"><img src="_manager/img/buttons/icon_edit.png" /></a>
