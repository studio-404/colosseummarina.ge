...
<?php if($_SESSION['auth']["class"] == '0') { ?>
							<a href="<?php echo ahref('langdata', 'edit', array('key'=>$sl['key']));?>" title="<?php echo a('ql.edit');?>"><img src="_manager/img/buttons/icon_edit.png" /></a>
<?php } ?>
							<a href="javascript:del('<?php echo $sl['key'];?>', '<?php echo $sl['key'];?>');" title="<?php echo a('ql.delete');?>"><img src="_manager/img/buttons/icon_delete.png" /></a>
						</div>									
