    <div id="title" class="fix">
        ...
        <div class="name"><?php echo ($subaction=='add') ? a('addimage') : a('editimage');?></div>
    </div>	
    ...
    <div id="box">
        <div id="part">
            ...
            <div id="t1" style="display:inline; visibility:visible;">
                <div id="news">
<?php $ulink = ($subaction=="add") ? ahref('imagegallery', 'add', array('menu' => $menu)) : ahref('imagegallery', 'edit', array('menu' => $menu, 'idx' => $idx)); ?>
                <form id="catform" name="catform" method="post" action="<?php echo $ulink;?>">
                   	<input type="hidden" name="imagegallery_form_perform" value="1" />
                        <div class="list2 fix">
                        ...
                        <div class="list fix">
	                        ...
	                        <textarea id="description" name="text_description" style="width:400px; height:300px; margin-top:2px; margin-bottom:2px;"><?php echo ($subaction=='edit') ? $description : '' ?></textarea>
		...
		function browse() {
			 ...
			 if($('#elfinder').length == 0) {
				 ...
				 $('#elfinder').elfinder('open');
                        ...
                        <!-- <div class="list fix">
                            <div class="name"><?php echo a("rolloverimage");?>: <span class="star">*</span></div>					
                            <input type="text" id="file2" name="file2" value="<?php echo ($subaction=='edit') ? $file2 : '' ?>" class="inp" style="width:500px;"/>
                            <a href="javascript:browse2();" class="button br" ><?php echo a("browse");?></a>
<script language="JavaScript">
		function browse2() {
			 aFieldName = 'file2', aWin = window;
			 if($('#elfinder').length == 0) {
				 $('body').append($('<div/>').attr('id', 'elfinder'));
				 $('#elfinder').elfinder({
					 url : '<?php echo c('site.url') . JAVASCRIPT;?>/elfinder/connectors/php/connector.php',
