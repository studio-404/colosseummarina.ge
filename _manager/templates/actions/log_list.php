...
?>
				<div id="bottom" class="fix">
					<ul id="page" class="fix left" style="width:720px; float: left;">
						<li><a href="<?php echo ahref('log', 'show', array('start' => 0));?>"><img src="_manager/img/prev2.png" width="5" height="5" alt=""  class="arrow" /></a></li>
						<li><a href="<?php echo ahref('log', 'show', array('start' => 50 * ($j - 1)));?>"><img src="_manager/img/prev.png" width="5" height="5" alt=""  class="arrow" /></a></li>
<?php
	for($i = $firstpage; $i<=$lastpage; $i++) {
?>
						<li><?php echo ($i == $curpage) ? '<span style="color:#2e84d7; font-weight:bold;">' : '<a href="'.ahref('log', 'show', array('start' => 50 * ($i - 1))).'">';?><?php echo $i;?><?php echo ($i == $curpage) ? '</span>' : '</a>';?></li>
<?php
	}
?>
						<li><a href="<?php echo ahref('log', 'show', array('start' => 50 * ($k - 1)));?>"><img src="_manager/img/next.png" width="5" height="5" alt="" class="arrow" /></a></li>
						<li><a href="<?php echo ahref('log', 'show', array('start' => 50 * ($lastpage - 1)));?>"><img src="_manager/img/next2.png" width="5" height="5" alt="" class="arrow" /></a></li>
					</ul>
					<a href="javascript:clear('<?php echo a('clearlogquestion');?>');" class="button br" style="float: right"><?php echo a("clearlog");?></a>
				</div>					
			</div>		
