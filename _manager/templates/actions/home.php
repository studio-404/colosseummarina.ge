			...
			<div class="smartblock fix">
				<div class="content br">
                        ...
                        <div class="list<?php echo $index;?> fix" style=" <?php echo ($index=='4') ? 'border:1px solid #e1e1e1;' : '';?>">
                            ...
                            <div class="smicon"><a href="<?php echo ahref('sitemap','show', array('menu'=>$cat['id']));?>"><img src="_manager/img/buttons/icon_edit.png" class="star" title="<?php echo a('ql.edit');?>" /></a></div> 	
                        </div>					
						<?php
                            endforeach;
                        ?>
			...
			<div class="smartblock fix" style="width:34%">
				<div class="content br">
                        ...
                        <div class="list<?php echo $index;?> fix" style=" <?php echo ($index=='4') ? 'border:1px solid #e1e1e1;' : '';?>;">
                            ...
                            <div class="smicon"><a href="<?php echo ahref($act,'show', array('menu'=>$cat['id']));?>"><img src="_manager/img/buttons/icon_edit.png" class="star" title="<?php echo a('ql.edit');?>" /></a></div> 	
                        </div>
                        <?php
                                }
                            endforeach;
			...
			<div class="smartblock fix">
				<div class="content br">
                        ...
                        <div class="list<?php echo $index;?> fix" style=" <?php echo ($index=='4') ? 'border:1px solid #e1e1e1;' : '';?>">
                            ...
                            <div class="smicon"><a href="<?php echo ahref($cat["type"],'show', array('menu'=>$cat['id']));?>"><img src="_manager/img/buttons/icon_edit.png" class="star" title="<?php echo a('ql.edit');?>" /></a></div> 	
                        </div>
						<?php
                                }
                            endforeach;
			...
			<div class="smartblock fix">
				<div class="content br">
                        ...
                        <div class="list<?php echo $index;?> fix" style=" <?php echo ($index=='4') ? 'border:1px solid #e1e1e1;' : '';?>">
                            ...
                            <div class="smicon"><a href="<?php echo ahref('banners','show', array('menu'=>$cat['id']));?>"><img src="_manager/img/buttons/icon_edit.png" class="star" title="<?php echo a('ql.edit');?>" /></a></div> 	
                        </div>
						<?php
                            endforeach;
                        ?>
			...
			<div class="smartblock fix" style="width:34%">
				<div class="content br">
                        ...
                        <div class="list4 fix" style="border:1px solid #e1e1e1;">
                            ...
                            <div class="smicon"><a href="<?php echo l(); ?>/ddadmin?action=users&subaction=show"><img src="_manager/img/buttons/icon_edit.png" class="star" title="<?php echo a('ql.edit');?>" /></a></div> 	
                        </div>						
                        <div class="list3 fix">
							<div class="name left"><a href="<?php echo l(); ?>/ddadmin?action=users&subaction=add"><span class="grey b"><?php echo a("newuser"); ?></span></a></div>							
                            <div class="smicon"><a href="<?php echo l(); ?>/ddadmin?action=users&subaction=add"><img src="_manager/img/buttons/icon_edit.png" class="star" title="<?php echo a('ql.edit');?>" /></a></div> 	
                        </div>
						<?php
                        ...
                        <div class="list4 fix" style="border:1px solid #e1e1e1;">
                            ...
                            <div class="smicon"><a href="<?php echo l(); ?>/ddadmin?action=userrights&subaction=add"><img src="_manager/img/buttons/icon_edit.png" class="star" title="<?php echo a('ql.edit');?>" /></a></div> 	
                        </div>					
					<?php
                            }
                    ?>                        
			...
			<div class="smartblock fix">
				<div class="content br">
                    ...
                    <div class="list4 fix" style="border:1px solid #e1e1e1;">
                        ...
                        <div class="smicon"><a href="<?php echo l(); ?>/ddadmin?action=settings&subaction=show"><img src="_manager/img/buttons/icon_edit.png" class="star" title="<?php echo a('ql.edit');?>" /></a></div> 	
                    </div>
                    <?php
                        }
                    ...
                    <div class="list3 fix">
                        ...
                        <div class="smicon"><a href="<?php echo l(); ?>/ddadmin?action=langdata&subaction=show"><img src="_manager/img/buttons/icon_edit.png" class="star" title="<?php echo a('ql.edit');?>" /></a></div> 	
                    </div>
                    <?php
                        }
                    ...
                    <div class="list4 fix" style="border:1px solid #e1e1e1;">
                        ...
                        <div class="smicon"><a href="<?php echo l(); ?>/ddadmin?action=backup&subaction=show"><img src="_manager/img/buttons/icon_edit.png" class="star" title="<?php echo a('ql.edit');?>" /></a></div> 	
                    </div>
                    <?php
                        }
                    ?>
