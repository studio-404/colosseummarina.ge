...
<?php
	...
	if(count($images) > 0) :
		foreach($images as $image) :
			$is_first = ($count == 1);
			$is_last = ($count >= $total);
			$arrow_up = $is_first ? '<img src="_manager/img/none.png" width="9" height="9" style="float:left;" />' : '<a href="' . ahref('imagegallery', 'move', array('where' => 'up', 'menu'=>$image['galleryid'], 'idx'=> $image['idx'])) . '"><img src="_manager/img/buttons/icon_arrow_up.png" alt="Move Up" title="Move Up" width="9" height="9" /></a>';
			$arrow_down = $is_last ? '<img src="_manager/img/none.png" width="9" height="9" style="float:left;" />' : '<a href="' . ahref('imagegallery', 'move', array('where' => 'down', 'menu'=>$image['galleryid'], 'idx'=> $image['idx'])) . '"><img src="_manager/img/buttons/icon_arrow_down.png" alt="Move Down" title="Move Down" width="9" height="9" /></a>';
...
?>
					<div id="list" class="<?php echo $class;?> fix">
						<div class="check">
							<a href="javascript:chclick(<?php echo $image['idx'];?>);"><img src="_manager/img/buttons/icon_<?php echo $ch;?>visible.png" class="star" title="<?php echo a('tt.visibility');?>" id="img_<?php echo $image['idx'];?>" style="width:9px;height:9px;" /></a>
						...
						<div class="action fix" style="padding-top:6px; width:120px;">
							<a class="preview" rel="lightbox[<?php echo $image['idx'];?>]" href="<?php echo $image["file"];?>" title="<?php echo a('ql.preview');?>"><img src="_manager/img/buttons/icon_preview.png" style="padding-right:1px;" /></a>
							<a href="<?php echo ahref('imagegallery', 'edit', array('idx' => $image['idx'], 'menu'=>$image['galleryid']));?>" title="<?php echo a('ql.edit');?>"><img src="_manager/img/buttons/icon_edit.png" /></a>
							<a href="javascript:del(<?php echo $image['id'];?>, '<?php echo $image['title'];?>');" title="<?php echo a('ql.delete');?>"><img src="_manager/img/buttons/icon_delete.png" /></a>
						</div>
