...
?>
					<div class="<?php echo $class;?> fix">
						...
						<div class="action2 fix">
                            <a href="<?php echo ahref($linktype,'show', array('menu'=>$topic["id"])) ?>" title="<?php echo a('ql.editcontent');?>"><img src="_manager/img/buttons/icon_files_edit.png" /></a>
							<a href="<?php echo ahref($type, 'edit', array('idx'=>$topic['idx']));?>" title="<?php echo a('ql.edit');?>"><img src="_manager/img/buttons/icon_edit.png" /></a>
<?php if(in_array($_GET["action"], array('pages', 'bannergroups'))) { ?>
