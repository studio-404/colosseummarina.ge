...
<div id="news">
    ...
    ?>
        ...
        <?php endif; ?>
            <div class="right fix"<?php !$has_photo AND print ' style="display: block; width: auto"'; ?>>
                <div class="info">
                    <span class="date"><?php echo convert_date($list[$idx]['pagedate']) ?></span>
    ...
    <?php if ($item_count > $num): ?>
        ...
        <?php if ($page_num > 1): ?>
                    ...
                    <a href="<?php echo href($section) ?>&page=<?php echo $page_num - 1 ?>">&lt;</a>
        <?php endif; ?>
        ...
        ?>
                        <a href="<?php echo href($section) ?>&page=<?php echo $idx ?>"<?php echo ($idx == $page_num ? ' style="font-weight: bold"' : NULL); ?>><?php echo $idx ?></a>
        <?php
                        endfor;
