...
//	'URL'             => $c["site.url"].'files/', 						// root directory URL
	'URL'             => 'http://colosseummarina.ge/files/', 				// root directory URL
	'rootAlias'       => 'Home',       									// display this instead of root directory name
	'uploadAllow'   => array('image/*', 'text/plain', 'application/pdf', 'audio/*', 'video/*'),
	'uploadDeny'    => array('text/x-php','application/*', 'application/octet-stream', 'text/x-python','text/x-shellscript','text/x-perl','text/x-ruby'),
